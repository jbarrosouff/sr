...
#importacao da biblioteca para raiz quadrada
...
tituloArtigos = []
tituloArtigos.append('Critical success factors in software process improvement: A systematic review. In: International Conference on Software rocess Improvement and Capability Determination. (BAYONA, Sussy; CALVO-MANZANO, Jose A.; SAN FELIU, Tomás - 2012).https://goo.gl/rVCeK8')
tituloArtigos.append('Release readiness indicator for mature agile and lean software development projects. Agile Processes in Software Engineering and Extreme Programming. (STARON, Miroslaw; MEDING, Wilhelm; PALM, Klasp - 2012).https://goo.gl/tQUqLt')
tituloArtigos.append('Which theory applies: An analysis of information systems research. Issues in information systems. ( HALAWI, Leila; MCCARTHY, Richard - 2006).https://goo.gl/71eJZB')
tituloArtigos.append('Human organizational patterns applied to collaborative learning software systems. (KOLP, Manuel; WAUTELET, Yves - 2015).https://goo.gl/GjXiLT')
tituloArtigos.append('Designing a peer-to-peer sharing service as fuel for the development of the electric vehicle charging infrastructure. In System Sciences (HICSS). (Matzner, M., Chasin, F., von Hoffen, M., Plenter, F., & Becker, J. - 2016)https://goo.gl/2ictLk')
tituloArtigos.append('Applying usability inspection techniques to evaluate mobile applications. (https://dl.acm.org/citation.cfm?id=1999615)')
tituloArtigos.append('Adoption of Agile Practices in a Traditional Environment: A Case Study (http://www.lbd.dcc.ufmg.br/colecoes/sbqs/2014/017.pdf)')
tituloArtigos.append('Interpreting E-government and Development: Efficiency, Transparency or Governance at a Distance? (https://link.springer.com/chapter/10.1057%2F9780230250611_5)')
tituloArtigos.append('Accessibility in Digital Cinema: A Proposal for Generation and Distribution of Audio Description (https://dl.acm.org/citation.cfm?id=2976867)')
tituloArtigos.append('Weaving semiotic engineering in meta-design: A case study analysis (http://www.sciencedirect.com/science/article/pii/S1045926X16300192)')
tituloArtigos.append('Trust-based access control for collaborative systems')
tituloArtigos.append('Modeling and performance analysis of networking and collaborative systems')
tituloArtigos.append('DESIGN FOR ASSESSMENT OF CONTRIBUTIONS IN COLLABORATIVE SYSTEMS(https://doaj.org/article/0d469196125b47ca859ac72960270850?frbrVersion=3)')
tituloArtigos.append('Structural and motivacional aspects and discursive zones in academic social software(https://doaj.org/article/2a563dce7e3443bb9036a4ba5ff05dbe)')
tituloArtigos.append('Product information management: basis for relationships in the supply chain(http://www.scielo.br/scielo.php?pid=S1807-17752008000100007&script=sci_arttext&tlng=pt)')
tituloArtigos.append('Online Social Network Evolution: Revisiting the Twitter Graph http://ieeexplore.ieee.org/abstract/document/7840655/')
tituloArtigos.append('Predicting Tie Strength With Social Media https://dl.acm.org/citation.cfm?id=1518736')
tituloArtigos.append('Friends and Neighbors on the Web http://www.sciencedirect.com/science/article/pii/S0378873303000091')
tituloArtigos.append('Spatio-Temporal Dynamics of Online Memes: A Study of Geo-Tagged Tweets https://dl.acm.org/citation.cfm?id=2488447&dl=ACM&coll=DL&CFID=992196168&CFTOKEN=48808050')
tituloArtigos.append('What is Twitter? a Social Network or a News Media? https://dl.acm.org/citation.cfm?id=1772751')
tituloArtigos.append('Collaborative Requirements Elicitation in Facilitated Collaboration: Report from a Case Study')
tituloArtigos.append('Mobile Collaboration for Business Process Elicitation from an Agile Development Methodology Viewpoint')
tituloArtigos.append('Collaborative ethnography: An approach to the elicitation of cognitive requirements of teams')
tituloArtigos.append('Distributed and Collaborative Requirements Elicitation Based on Social Intelligence')
tituloArtigos.append('Distributed elicitation of software requirements: An experimental case from Argentina and Colombia')
tituloArtigos.append('A1 - Accessibility of the smart home for users with visual disabilities: an evaluation of open source mobile applications for home automation')
tituloArtigos.append('A2 - Accessibility of Cultural Heritage Exhibits ')
tituloArtigos.append('A3 - Biography of a Design Project through the Lens of a Facebook Page')
tituloArtigos.append('A4 - Collaboration on Social Network Sites: Amateurs, Professionals and Celebrities')
tituloArtigos.append('A5 - From Facebook to the Neighbourhood: Infrastructuring of Hybrid Community Engagement ')
tituloArtigos.append('A1 - How blind people interact with visual content on social networking services')
tituloArtigos.append('A2 - Lean principles, practices, and impacts: a study on small and medium-sized enterprises (SMEs).')
tituloArtigos.append('A3 - Accessible Crowdwork?')
tituloArtigos.append('A4 - Why Is Accessibility So Hard?')
tituloArtigos.append('A5 - Interpretive case studies in IS research: nature and method.')
tituloArtigos.append('A1 - Perceived Usefulness, Perceived Ease of Use, and User Acceptance of Information Technology')
tituloArtigos.append('A2 - Four paradigms of information systems development ')
tituloArtigos.append('A3 - Research of a synchronized cooperative GIS system based on message')
tituloArtigos.append('A4 - A framework of ICT exploitation for e-participation initiatives ')
tituloArtigos.append('A5 - E-Participation, Transparency, and Trust in Local Government ')
tituloArtigos.append('A1 - Usability and consumption influence of fashion blogs: an exploratory study')
tituloArtigos.append('A2 - Influence of a head-mounted display on user experience and performance in a virtual reality-based sports application')
tituloArtigos.append('A3 - Evaluation of the emotional answer in HRI on a game situation')
tituloArtigos.append('A4 - Application Requirements for Deaf Students to use in Inclusive Classrooms')
tituloArtigos.append('A5 - Florch: Challenges on developing a new social network accessible for senescent users')
tituloArtigos.append('Faking Sandy: Characterizing and Identifying Fake Images on Twitter during Hurricane Sandy"')
tituloArtigos.append('Fake News in Social Networks')
tituloArtigos.append('Fake News Detection on Social Media: A Data Mining Perspective')
tituloArtigos.append('Tweet Analysis for Real-Time Event Detection and Earthquake Reporting System Development"')
tituloArtigos.append('UNIK: Unsupervised Social Network Spam Detection')
tituloArtigos.append('Improving the accuracy of collaborative filtering recommendations using clustering and association rules mining on implicit dataImproving the accuracy of collaborative filtering recommendations using clustering and association rules mining on implicit data')
tituloArtigos.append('Collaborative filtering using multiple binary maximum margin matrix factorizations')
tituloArtigos.append('A k-anonymous approach to privacy preserving collaborative filtering')
tituloArtigos.append('Improving the accuracy of top- N recommendation using a preference model')
tituloArtigos.append('What makes users share content on facebook? Compatibility among psychological incentive, social capital focus, and content type')
...
for item in vetorItemNaoAvaliados:
    ...
    for i in range(20):
        ...
        produto = produto + (vetorPesosUsuarioCorrente[i] * resultado[item][i])
